INSERT INTO secretsDeHammam_test.role (name) VALUES
('admin'),
('user');

INSERT INTO secretsDeHammam_test.category (name) VALUES
('Savons'),
('Huiles'),
('Gommages'),
('Shampoings'),
...
INSERT INTO secretsDeHammam_test.skin (type) VALUES
('Normale'),
('Sèche'),
('Grasse'),
('Mixte'),
...
INSERT INTO secretsDeHammam_test.pack (name, price) VALUES
('Rituel Hammam Complet', 49.90),
('Pack Bien-Être', 29.90),
('Découverte Oriental', 19.90),
('Coffret Luxe', 69.90);

INSERT INTO secretsDeHammam_test.body_part (name) VALUES
('Visage'),
('Corps'),
('Cheveux'),
('Mains'),
...
INSERT INTO secretsDeHammam_test.product 
...
INSERT INTO secretsDeHammam_test.user (email, password, role_id, skin_id) VALUES
...
INSERT INTO secretsDeHammam_test.product_skin (product_id, skin_id) VALUES
(1, 2), (1, 3), (1, 4),
(3, 2), (3, 5),
(4, 3), (4, 4),
(6, 6), (6, 5),
...
INSERT INTO secretsDeHammam_test.product_pack VALUES
(1, 1), (2, 1), (3, 1), (4, 1),
(3, 2), (7, 2),
(1, 3), (8, 3),
(3, 4), (6, 4), (10, 4);

INSERT INTO secretsDeHammam_test.product_body_part VALUES
(1, 2),
(2, 2),
(3, 2), (3, 3),
(4, 1), (4, 3),
